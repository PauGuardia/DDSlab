...
events$smeanz <- NULL
events$dmeanz <- NULL
events$transdepth <- NULL
events$ressbdylen <- NULL
events$Sjit <- NULL
events$Djit <- NULL
events$Stime <- NULL
events$Ltime <- NULL
...
events$synack <- NULL
events$ackdat <- NULL
events$issmipsports <- NULL
events$ctstatettl <- NULL
events$ctsrvdst <- NULL
events$ctsrvsrc <- NULL
events$ctsrcdportltm <- NULL
events$ctdstsportltm <- NULL
events$state <- NULL
events$srcip <- NULL
events$srport <- NULL
events$dport <- NULL
